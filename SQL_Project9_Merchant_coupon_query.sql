...
INNER JOIN campaign_coupons cc ON cd.campaign_id = cc.campaign_id
LEFT JOIN train ct ON cd.campaign_id = ct.campaign_id
GROUP BY 
  cd.campaign_type,
  cc.coupon_count
HAVING used_coupons / cc.coupon_count < 0.2 -- Adjust threshold as needed
ORDER BY used_coupons / cc.coupon_count ASC;
...
GROUP BY 
  cd.campaign_type
HAVING used_coupons / total_coupons < 0.2 -- Adjust threshold as needed
ORDER BY used_coupons / total_coupons ASC;
